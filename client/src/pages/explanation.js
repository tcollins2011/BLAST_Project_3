...
function Explanation() {
  return (
    <Container fluid>
      ...
      <Container classNAme = 'imageArea'>image</Container>
    </Container>
    ...
    //   <p></p>
    //   <Image source={require("../utils/blastImages/Figure_3.jpg")}></Image>
    //   <li>
    ...
    //   <p></p>
    //   <li>
    //     Scan the database sequences for exact matches with the remaining
    //     high-scoring words.
    //   </li>
    //   <p>
    ...
    //   </p>
    //   <li>
    //     List all of the HSPs in the database whose score is high enough to be
    //     considered.
    //   </li>
    //   <p>
    ...
    //   </p>
    //   <li>
    //     Show the gapped Smith-Waterman local alignments of the query and each of
    //     the matched database sequences.
    //   </li>
    //   <p></p>
    //   <li>
    //     Report every match whose expect score is lower than a threshold
    //     parameter E.
    //   </li>
    //   <p></p>
    // </div>
